# -*- coding: utf-8 -*-
"""
Build Group E snapshot: merge latest tags + factors_latest, compute group_e
representatives and deviations. Returns E snapshot DataFrame; does not save history.
Optional: save E latest-only file. Independent runnable.
"""
...
def build_group_e_snapshot_df(
    logic_dir: str | Path | None = None,
    data_dir: str | Path | None = None,
) -> pd.DataFrame:
    """
    Build Group E snapshot DataFrame: latest tags + factors merge, group_e reps and deviations.
...
def main() -> None:
    ...
    snapshot_df = build_group_e_snapshot_df(logic_dir=DEFAULT_LOGIC_DIR, data_dir=DEFAULT_DATA_DIR)
